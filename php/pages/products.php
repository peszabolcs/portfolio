...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/php/src/css/style.css">
    <link rel="icon" type="image/png" href="/php/src/css/style.css">
</head>
<body>
        ...
        <div class="products-container">
            ...
            <?php
                foreach ($data['products'] as $product) {
                    ...
                    echo '<img src="/php/src/img/tocart.png" alt="kosarba">';
                    echo '</button>';
                    echo '</div>';
                    echo '</form>';
                    echo '</div>';
